    ...
    <Card className="w-full bg-white rounded-3xl shadow-lg overflow-hidden shadow-md shadow-black/10">
      ...
      <CardContent className="p-0">
        <div className="overflow-x-auto">
          ...
          <div className="h-[375px] overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-[#F8F0FF] [&::-webkit-scrollbar-thumb]:bg-[#5b06be] [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-[#7016e0]">
            <table className="w-full table-fixed">
              <tbody>
